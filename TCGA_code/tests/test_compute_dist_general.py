...
def test_compute_dist_gen():
    ...
    assert distance == expected_distance, "The distance between is 0 not " + str(distance)# "The distance between " + str(profile) + " and " + str(sample_data) +" is 0 not " + str(distance)